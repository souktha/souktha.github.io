.. title: Adding ARM platform to QEMU 5.2.0
.. slug: qemu-port
...
are met the package should be built successfully. To build as-is for ARM, extract the package then *cd qemu-5.2.0* to configure
and build,
...
In QEMU directories structure, I only needed to work in two directories, *hw/arm* and *default-configs/devices* to add
